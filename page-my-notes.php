<?php
    ...
    <div class="container container--narrow page-section">
        <div class="create-note">
            ...
            <span class="note-limit-message">Note limit reached: delete an existing note to add more notes.</span>
        </div>
            ...
            <?php
                ...
                while($userNotes->have_posts()) {
                    ...
                    <li data-id="<?php the_ID() ?>">
                        <input value="<?php echo str_replace('Private: ', '' , esc_attr(get_the_title())) ?>" readonly class="note-title-field">
