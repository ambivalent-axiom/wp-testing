...
<header class="site-header">
      <div class="container">
        ...
        <div class="site-header__menu group">
          ...
          )) ?> paraugs kā sataisīt menu no datubāzes-->
            <ul>
              <li <?php if (is_page('about-us') || get_post_field('post_name', wp_get_post_parent_id(0)) === 'about-us') echo 'class="current-menu-item"'?>>
